  ...
  template: `
    <div class="modal-container bg-orange-50">
      ...
      <div class="form-control w-full max-w-xs">
        ...
        <input type="password" placeholder="Auth Code" [(ngModel)]="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 input-accent w-full max-w-xs" />
        <label class="label">
